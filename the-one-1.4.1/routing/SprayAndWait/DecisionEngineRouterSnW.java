 ...
 */
public class DecisionEngineRouterSnW extends ActiveRouter //extends DecisionEngineRouterSnW untuk mengedit transfer done, ditambahkan update property
{
	...
	protected RoutingDecisionEngineSnW decider;
	...
	public DecisionEngineRouterSnW(Settings s) {
            ...
            decider = (RoutingDecisionEngineSnW)routeSettings.createIntializedObject(
	...
	protected void transferDone(Connection con) {
		...
		Tuple<Message, Connection> t = i.next();
            ...
            decider.transferDone(con); //update property untuk menambahkan transfer done dengan proses pengupdatetan property
	...
	public RoutingDecisionEngineSnW getDecisionEngine()
	{
            return this.decider;
	}
