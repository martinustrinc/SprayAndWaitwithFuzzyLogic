 ...
 */
public class TotalCopyMessagePerContactReport extends Report implements MessageListener, ConnectionListener{
	...
	private int lastRecord = 0;
        ...
        private Map<Integer, Integer> totalCopyMessage;
	 ...
	 * Constructor.
	 */
	public TotalCopyMessagePerContactReport() {
		init();
	}
	...
	protected void init() {
		...
		this.interval = DEFAULT_CONTACT_COUNT;
                this.totalCopyMessage = new HashMap<>();
		this.nrofDropped = 0;
		this.nrofRemoved = 0;
		this.nrofStarted = 0;
		this.nrofAborted = 0;
	...
	public void done() {
            ...
            for (Map.Entry<Integer, Integer> entry : totalCopyMessage.entrySet()) {
        ...
        public void hostsConnected(DTNHost host1, DTNHost host2) {
                ...
                if (TOTAL_CONTACT - lastRecord >= interval) {
                    ...
                    totalCopyMessage.put(lastRecord, totalHopCount);
                }
        }
